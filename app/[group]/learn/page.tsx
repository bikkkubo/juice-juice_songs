...
export async function generateMetadata({
  ...
  return groupMetadata({
    group,
    title: "基本のコールを学ぶ",
    description: `${group.name} の初心者向けコール練習ページです。`,
    path: `/${group.slug}/learn`,
  });
}
      ...
      <main className="mx-auto max-w-page px-5 pb-24 pt-6">
        ...
        <header className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-ink-weak">
            最近{group.name}を知った人向けの入口です。完璧に覚えるより、まずは表示されたコールを見ながらライブ映像に合わせるところから始めます。
          </p>
        </header>
